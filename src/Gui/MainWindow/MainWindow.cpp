...
const char COMMUNITY_FORUM_URL[] = "http://cryptobid.xyz";
const char REPORT_ISSUE_URL[] = "http://cryptobid.xyz";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("cryptobid Wallet %1").arg(Settings::instance().getVersion()));
